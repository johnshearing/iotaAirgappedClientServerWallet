...
console.log('This is the object originalCheckData: ', originalCheckData);
...
console.log('This is the moduleToUse: ', _moduleToUse);
...
var req = _moduleToUse.request(requestDetails,function(res){
    ...
    if(!outcomeSent){
        console.log('This is the checkOutcome object: ', checkOutcome);
