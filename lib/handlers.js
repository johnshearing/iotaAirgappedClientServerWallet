...
// Define the handler function for deleting a user session.
...
// End of: // Define the handler function for deleting a user session.
...
handlers._tokens.delete = function(data, callback){
  ...
  if(id)
  {
    ...
    console.log('The logic passed through here');
