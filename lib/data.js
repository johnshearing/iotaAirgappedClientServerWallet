...
lib.nextId = function()
{
    ...
    dbHistoryDir = lib.baseDir + 'dbHistory/'
    ...
    // Call read function to get the nextId object then run the callback function defined here.
    lib.read('dbHistory', 'gsuid', function(err, nextIdObject)
    {
      ...
      else // there was an error or no data was returned
      {
