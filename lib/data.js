...
lib.gsuidLockReadIncUnlock = function(callback)
{
  ...
  try 
  {
    ...
    fs.mkdirSync(dbHistoryDir + 'lock'); 
    ...
    lib.read('dbHistory', 'gsuid', function(err, nextIdObject)
    {
      ...
      if(!err && nextIdObject)
      {
        ...
        lib.update('dbHistory', 'gsuid', nextIdObject, function(err)
        {
          if(!err) // There was no error writing the incremented nextId back to the file.
          {
            ...
            fs.rmdirSync(dbHistoryDir + 'lock');

            console.log('qtjwjum5b9l4ww8wo1ra');
            console.log('Got a good locked read');
            console.log('');
          ...
          {
            console.log('97xxiel6uubzxgzc1j13');
            console.log('There was an error writing the incremented nextId back to the file:');
      ...
      {
        console.log('vqihr0azmm9vasc21884');
        console.log('Problem reading gsuid.json.');
  ...
  catch(err) 
  {
    ...
    {   
      console.log('zz1iv0q1o0702wk5e3sn')
      console.log('Could not get a lock.');    
      console.log('');
    ...
    {
      console.log('clp1z82jq8wauo0y7fbb');
      console.log('An error occured when trying to get a locked read on the Global Sequential Unique ID');
      console.log('This is the error \n', err);
      console.log('');
...
{
  // Determine how many times to try getting a lock.
  var tryCount = 1;

  // Attempt a locked read and increment the gsuid.
  lib.gsuidLockReadIncUnlock(function(stopTrying, error, nextIdObject)
  {
    console.log('r2rffhtkfpobma6qsj5k');
    console.log('The tryCount is ' + tryCount);
    console.log('');

    // If the gsuid file was locked we are going to try again in hopes it is now released.
    if(stopTrying == false && nextIdObject == false)
    {
      // Call setInterval to attempt a lock every 3 seconds.
      // The intervalControlObject is created when we call setInterval.
      // This will be used to stop setInterval from firing after we get a lock or after the maximum number of 
      // lock attempts have been exceeded. 
      ...
      setInterval(lib.gsuidLockReadIncUnlock, 3000, function(stopTrying, error, nextIdObject)
      {
        ...
        if (stopTrying == false && nextIdObject == false)
        {
          ...
          console.log('gnx7bp81kmswpajdo06f');
        ...
        else if(stopTrying == true && nextIdObject == false) 
        {
          ...
          console.log('p9hjguitshfc7vxxxs92');
          console.log('We got a lock on the gsuid file but there was a problem reading it.');
          console.log('This is the error: \n', error);    
          console.log('');        
             ...
             // to increment the id and write it back to the file.
        {
          ...
          console.log('kv323g8n4otmv5m08zfv');
          console.log('Success! ', nextIdObject);
          console.log('');
        ...
        if(tryCount == 5)
        {
          ...
          console.log('1xjvjk25hsx1z81ov41a');
          console.log('Maximum number of tries has been exceeded.');
          console.log('');
    ...
    {
      console.log('egnqfq48ru4319c7sa4a');
      console.log('We got a lock on the gsuid file but there was a problem reading it.');
      console.log('This is the error: \n', error);   
      console.log('');
    ...
    {
      console.log('q2ba5ibvz4fa8cu6r6cg');
      console.log('Success! ', nextIdObject);
      console.log('');
