 ...
 * Have database functionality. 
   ...
   * I have 4 database choices to consider SQL, NoSQL, Roll my own, The Tangle. I am roughing out the application with a DIY JSON database [taught by Leslie Lewis here](https://pirple.thinkific.com/courses/the-nodejs-master-class). Once I get a better feel for how everything fits together I will decide which database(s) should be used.  
